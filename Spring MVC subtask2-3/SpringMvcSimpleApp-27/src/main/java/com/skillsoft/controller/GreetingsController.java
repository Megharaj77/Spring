...
//    		 @RequestParam String major,Model model) {
...
//    public String greeting(
//   		 @RequestParam("studentName")String name,
//   		 @RequestParam (required=false)String major,Model model) {
//   	  
//   	  String msg="Hello "+name;
//   	  
...
//    public String greeting(
//   		 @RequestParam("studentName")String name,
//   		 @RequestParam (defaultValue="English")String major,Model model) {
//   	  
//   	  String msg="Hello "+name+"welcome to your major:"+major;
//   	  
//		model.addAttribute("message",msg);
...
//    }
	...
	public String greeting(
		...
		String msg="Hello "+name+"welcome to your major: "+major+",your advisor is: "+advisor;
