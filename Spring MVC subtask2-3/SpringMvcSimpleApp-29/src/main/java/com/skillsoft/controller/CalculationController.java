...
public class CalculationController {
	...
	public String greeting(@RequestParam("number1") int number1, @RequestParam("number2") int number2, Model model)
			throws SQLException {
		...
		String message = "Here are your calculation results for: " + number1 + " and " + number2;
